...
controlHandlerForBinaryOutput(ControlAction action, void* parameter, MmsValue* value, bool test)
{
    ...
    if (parameter == IEDMODEL_GenericIO_GGIO1_SPCSO1) {
        IedServer_updateAttributeValue(iedServer, IEDMODEL_GenericIO_GGIO1_NamPlt_IED13S, value);
        // publishGooseMsg(getReceiverId("SERVER_IED16"), 3, value);
        publishGooseMsg("SERVER_IED16", 3, value);
