...
DataAttribute iedModel_GenericIO_LLN0_NamPlt_AI1 = {
    ...
    "AI1",
    (ModelNode*) &iedModel_GenericIO_LLN0_NamPlt,
    (ModelNode*) &iedModel_GenericIO_LLN0_NamPlt_IED4S,
    NULL,
    0,
    IEC61850_FC_DC,
    IEC61850_FLOAT32,
...
DataAttribute iedModel_GenericIO_LLN0_NamPlt_IED4S = {
    DataAttributeModelType,
    "IED4S",
    (ModelNode*) &iedModel_GenericIO_LLN0_NamPlt,
    NULL,
...
DataAttribute iedModel_GenericIO_LPHD1_PhyNam_AI1 = {
    ...
    "AI1",
    (ModelNode*) &iedModel_GenericIO_LPHD1_PhyNam,
    (ModelNode*) &iedModel_GenericIO_LPHD1_PhyNam_IED4S,
    NULL,
    0,
    IEC61850_FC_DC,
    IEC61850_FLOAT32,
...
DataAttribute iedModel_GenericIO_LPHD1_PhyNam_IED4S = {
    DataAttributeModelType,
    "IED4S",
    (ModelNode*) &iedModel_GenericIO_LPHD1_PhyNam,
    NULL,
...
DataAttribute iedModel_GenericIO_GGIO1_NamPlt_AI1 = {
    ...
    "AI1",
    (ModelNode*) &iedModel_GenericIO_GGIO1_NamPlt,
    (ModelNode*) &iedModel_GenericIO_GGIO1_NamPlt_IED4S,
    NULL,
    0,
    IEC61850_FC_DC,
    IEC61850_FLOAT32,
...
DataAttribute iedModel_GenericIO_GGIO1_NamPlt_IED4S = {
    DataAttributeModelType,
    "IED4S",
    (ModelNode*) &iedModel_GenericIO_GGIO1_NamPlt,
    NULL,
...
iedModel_GenericIO_LLN0_NamPlt_IED4S.mmsValue = MmsValue_newBoolean(false);
