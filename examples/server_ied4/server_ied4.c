...
controlHandlerForBinaryOutput(ControlAction action, void* parameter, MmsValue* value, bool test)
{
    ...
    if (parameter == IEDMODEL_GenericIO_GGIO1_SPCSO1) {
        IedServer_updateAttributeValue(iedServer, IEDMODEL_GenericIO_GGIO1_NamPlt_IED4S, value);
        // publishGooseMsg(getReceiverId("SERVER_IED1"), 1, value);
        // publishGooseMsg(getReceiverId("SERVER_IED16"), 1, value);
        publishGooseMsg("SERVER_IED1", 1, value);
        publishGooseMsg("SERVER_IED16", 1, value);
...
main(int argc, char** argv)
{
    ...
    writeLog("Using interface %s for goose\n", gooseInterface);
